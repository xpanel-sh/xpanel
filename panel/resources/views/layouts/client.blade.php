...
<head>
    ...
    <link href="{{ asset('assets/media/app/favicon-32x32.png') }}" rel="icon" sizes="32x32"
        type="image/png" />
    <link href="{{ asset('assets/media/app/favicon-16x16.png') }}" rel="icon" sizes="16x16"
        type="image/png" />
...
@php
    ...
    $clientHasSecondarySidebar = $clientRouteDomainForSidebar !== '';
@endphp
<body class="antialiased flex h-full text-base text-foreground bg-background [--header-height:60px] {{ $clientHasSecondarySidebar ? '[--sidebar-width:290px]' : '[--sidebar-width:90px]' }} [--navbar-height:56px] bg-muted! lg:overflow-hidden">
    <!-- Theme Mode -->
    <script>
    ...
    @php
        ...
        $selectedSite = $routeSite instanceof \App\Models\Site
            ? $clientSites->firstWhere('id', $routeSite->id)
            : null;

        $routeDomain = trim((string) request()->route('domain'), '/');
        $routeDomain = $routeDomain !== '' ? strtolower(explode('/', $routeDomain)[0] ?? '') : null;
        $selectedSite = $selectedSite ?: ($routeDomain ? $clientSites->firstWhere('domain', $routeDomain) : null);
    ...
    <div class="flex grow">
        <!-- Header -->
        <header class="flex items-center fixed z-10 top-0 left-0 right-0 shrink-0 h-(--header-height) bg-muted z-89"
            style=" z-index: 89; margin-left: 90px;">
            <div class="kt-container-fluid flex justify-between items-stretch px-5 lg:ps-0 lg:gap-4"
                ...
                <div class="flex items-center me-1">
                    <div class="flex items-center justify-center gap-1 shrink-0">
                        ...
                        <a class="mx-1 lg:hidden" href="/metronic/tailwind/demo3/">
                    ...
                    <div class="flex items-center @if($selectedSiteDomain) mx-5 @endIf">
                        ...
                        <div class="kt-menu kt-menu-default" data-kt-menu="true">
                            <div class="kt-menu-item kt-menu-item-dropdown" data-kt-menu-item-offset="0, 10px"
                                ...
                                <button class="kt-menu-toggle text-mono font-medium">
                                    {{ $selectedSiteDomain ?? 'Websites' }}
                                    <span class="kt-menu-arrow">
                                        <i class="ki-filled ki-down">
                                        </i>
                                    </span>
                                </button>
                                <div class="kt-menu-dropdown w-48 py-2" style="">
                                @forelse($clientSites as $clientSite)
                                        ...
                                        <div class="kt-menu-item {{ $siteIsActive ? 'active' : '' }}">
                                            <a class="kt-menu-link" href="{{ route('client.websites.show', ['domain' => $clientSite->domain]) }}" tabindex="0">
                                    ...
                                    <div class="kt-menu-item">
                                        <a class="kt-menu-link" href="{{ route('client.websites.create') }}" tabindex="0">
                                            <span class="kt-menu-icon">
                                            ...
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-4.png" />
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-1.png" />
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-2.png" />
                                                </div>
                                                <div class="flex">
                                                    <span
                                ...
                                <div class="flex flex-col gap-5 py-5">
                                    <div class="flex items-end gap-3.5 px-5">
                                        <img alt="" class="rounded-full size-9"
                                            src="/metronic/tailwind/dist/assets/media/avatars/300-5.png" />
                            ...
                            <div class="mb-2.5">
                                <div class="flex grow gap-2 px-5 py-3.5 bg-accent/60 mb-2.5 border-y border-border"
                                    ...
                                    <div class="kt-avatar size-9">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar"
                                                src="/metronic/tailwind/dist/assets/media/avatars/300-14.png">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                    ...
                                    <div class="grow flex flex-col gap-5 pt-3 pb-4 divider-y divider-border">
                                        ...
                                        <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-27.png" />
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                    </div>
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-10.png" />
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            ...
                                            <div class="flex flex-col gap-3.5 grow">
                                                ...
                                                <div
                                                    ...
                                                    <img class="h-5"
                                                        src="/metronic/tailwind/dist/assets/media/file-types/pdf.svg" />
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-11.png">
                                                    </img>
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            ...
                                            <div class="flex flex-col gap-3.5 grow">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <img class="h-5"
                                                            src="/metronic/tailwind/dist/assets/media/file-types/figma.svg" />
                                                    </div>
                                                    <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1"
                                                        href="#">
                                                        Launcher-UIkit.fig
                                    ...
                                    <div class="flex flex-col gap-5 pt-3 pb-4">
                                        <div class="flex grow gap-2.5 px-5" id="notification_request_13">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-25.png">
                                                    </img>
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-34.png" />
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                    </div>
                                            ...
                                            <div class="flex flex-col gap-3.5 grow">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-1.5">
                                                        <img class="h-6"
                                                            src="/metronic/tailwind/dist/assets/media/file-types/xls.svg" />
                                        ...
                                        <div class="flex grow gap-2 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-29.png">
                                                    </img>
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                        ...
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                                    src="/metronic/tailwind/dist/assets/media/avatars/300-3.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                                    src="/metronic/tailwind/dist/assets/media/avatars/300-2.png" />
                                        ...
                                        <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-30.png">
                                                    </img>
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-24.png">
                                                    </img>
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                    ...
                                    <div class="flex flex-col gap-5 pt-3 pb-4">
                                        <div class="flex grow gap-2 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-15.png" />
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                    </div>
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-6.png">
                                                    </img>
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-12.png">
                                                    </img>
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            ...
                                            <div class="flex flex-col gap-3.5 grow">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-1.5">
                                                        <img class="h-6"
                                                            src="/metronic/tailwind/dist/assets/media/file-types/word.svg" />
                                                        <div class="flex flex-col gap-0.5">
                                                            <a class="hover:text-primary font-medium text-secondary-foreground text-xs"
                                                                href="#">
                                                                Landing-page.docx
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-1.5">
                                                        <img class="h-6"
                                                            src="/metronic/tailwind/dist/assets/media/file-types/svg.svg" />
                                                        <div class="flex flex-col gap-0.5">
                                                            <a class="hover:text-primary font-medium text-secondary-foreground text-xs"
                                                                href="#">
                                                                New-icon.svg
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-21.png">
                                                    </img>
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                        ...
                                        <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-13.png">
                                                    </img>
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                    ...
                                    <div class="flex flex-col gap-5 pt-3 pb-4">
                                                ...
                                                <div class="flex items-center gap-2.5">
                                                    <div
                                                        ...
                                                        <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24"
                                                            style="background-image: url('/metronic/tailwind/dist/assets/media/images/600x600/6.jpg')">
                                                        </div>
                                                    ...
                                                    <div
                                                        class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
                                                        <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24"
                                                            style="background-image: url('/metronic/tailwind/dist/assets/media/images/600x600/1.jpg')">
                                                        </div>
                                                        <div class="px-2.5 pb-2">
                                                            <a class="font-medium block text-secondary-foreground hover:text-primary text-xs leading-4 mb-0.5"
                                                                href="#">
                                        ...
                                        <div class="flex grow gap-2.5 px-5" id="notification_request_17">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-19.png" />
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                    </div>
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-17.png" />
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                    </div>
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            <div class="kt-avatar size-8">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar"
                                                        src="/metronic/tailwind/dist/assets/media/avatars/300-9.png" />
                                                </div>
                                                <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                    <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                    </div>
                    ...
                    <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px"
                        ...
                        <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
                            <img alt="" class="size-9 rounded-full border-2 border-input shrink-0"
                                src="/metronic/tailwind/dist/assets/media/avatars/gray/5.png" />
                        </div>
                        <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
                                    ...
                                    <button class="kt-dropdown-menu-toggle py-1" data-kt-dropdown-toggle="true">
                                        ...
                                        <span class="ms-auto kt-badge kt-badge-stroke shrink-0">
                                            ...
                                            <img alt="" class="inline-block size-3.5 rounded-full"
                                                src="/metronic/tailwind/dist/assets/media/flags/united-states.svg" />
                                        </span>
                                    </button>
                                        ...
                                        <ul class="kt-dropdown-menu-sub">
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=rtl">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="/metronic/tailwind/dist/assets/media/flags/saudi-arabia.svg" />
                                                        <span class="kt-menu-title">
                                                            Arabic(Saudi)
                                                        </span>
                                                    </span>
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="/metronic/tailwind/dist/assets/media/flags/spain.svg" />
                                                        <span class="kt-menu-title">
                                                            Spanish
                                                        </span>
                                                    </span>
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="/metronic/tailwind/dist/assets/media/flags/germany.svg" />
                                                        <span class="kt-menu-title">
                                                            German
                                                        </span>
                                                    </span>
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="/metronic/tailwind/dist/assets/media/flags/japan.svg" />
                                                        <span class="kt-menu-title">
                                                            Japanese
                                                        </span>
                                                    </span>
                            ...
                            <div class="px-2.5 pt-1.5 mb-2.5 flex flex-col gap-3.5">
                                ...
                                <a class="kt-btn kt-btn-outline justify-center w-full"
                                    href="/metronic/tailwind/demo3/authentication/classic/sign-in">
                                    Log out
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]"
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-offset="-15px, 0"
                                    ...
                                    <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/metronic/tailwind/demo4/account/home/settings-sidebar">
                                                <span class="kt-menu-icon">
                                                    <i class="ki-filled ki-sms">
                                                    </i>
                                                </span>
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            ...
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="/metronic/tailwind/dist/assets/media/avatars/300-8.png" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="/metronic/tailwind/dist/assets/media/avatars/300-18.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="/metronic/tailwind/dist/assets/media/avatars/300-17.png" />
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            ...
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="/metronic/tailwind/dist/assets/media/avatars/300-20.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="/metronic/tailwind/dist/assets/media/avatars/300-21.png" />
                        ...
                        <div class="kt-menu kt-menu-default px-0.5 flex-col">
                            <div class="grid">
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="/metronic/tailwind/dist/assets/media/file-types/pdf.svg" />
                                            <div class="flex flex-col">
                                                <span
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="/metronic/tailwind/dist/assets/media/file-types/doc.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    Report-v1.docx
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img
                                                src="/metronic/tailwind/dist/assets/media/file-types/javascript.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    Framework-App.js
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="/metronic/tailwind/dist/assets/media/file-types/ai.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    Framework-App.js
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="/metronic/tailwind/dist/assets/media/file-types/php.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    appController.js
                        ...
                        <div class="flex flex-col text-center py-9 gap-5">
                            <div class="flex justify-center">
                                <img alt="image" class="dark:hidden max-h-[113px]"
                                    src="/metronic/tailwind/dist/assets/media/illustrations/33.svg" />
                                <img alt="image" class="light:hidden max-h-[113px]"
                                    src="/metronic/tailwind/dist/assets/media/illustrations/33-dark.svg" />
                            </div>
                            <div class="flex flex-col gap-1.5">
