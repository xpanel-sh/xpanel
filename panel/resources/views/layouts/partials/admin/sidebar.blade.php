@php
    $sideItems = [
        ...
        ['label' => 'Sitios', 'route' => 'admin.sites.index', 'match' => ['admin.sites.*', 'admin.files.*'], 'icon' => 'ki-website'],
        ['label' => 'Dominios', 'route' => 'admin.domains.index', 'match' => ['admin.domains.*'], 'icon' => 'ki-globe'],
