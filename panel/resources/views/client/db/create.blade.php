                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-1 text-sm">
                                        <a class="text-secondary-foreground hover:text-primary"
                                            href="{{ route('client.databases.index') }}">Bases de datos</a>
                                        <span class="text-muted-foreground">/</span>
                                        <span class="text-mono">Nueva</span>
                                    </div>
                                </div>
                                <a href="{{ route('client.databases.index') }}"
                                    class="kt-btn kt-btn-outline kt-btn-sm">Volver</a>
                            </div>
                                ...
                                <div class="kt-card-content grid gap-5">
                                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                        ...
                                        <div class="grow grid gap-1.5">
                                            <input class="kt-input" type="text" name="name"
                                                value="{{ old('name') }}" required pattern="[A-Za-z0-9_]+"
                                                placeholder="app_db">
                                    ...
                                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                        ...
                                        <div class="grow grid gap-1.5">
                                            ...
                                            <p class="kt-form-description">El usuario se creara dentro del motor
                                                seleccionado.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                        ...
                                        <div class="grow grid gap-1.5">
                                            <input class="kt-input" type="password" name="password" required minlength="16"
                                                autocomplete="new-password" placeholder="Minimo 16 caracteres">
                                            <p class="kt-form-description">XPanel no mostrara esta contrasena despues de
                                                crearla.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                    ...
                                    <div class="flex justify-end gap-2.5">
                                        <a href="{{ route('client.databases.index') }}"
                                            class="kt-btn kt-btn-outline">Cancelar</a>
